...
<html lang="en">
  ...
  <div class="container" style="background-image: linear-gradient(to right, #ea5040 , #e83b81);">
    <div class="row" style="height: 100px;">
      <div class="col">
        <a href="index.html"><img src="fleche.png" class="align-middle img-fluid mx-auto d-block" style="width: 50px; margin-top: 20px;"></a>
      </div>
      <div class="col">
  ...
  <div class="container fixed-bottom bg-light py-4 border border-3">
    <div class="row">
      <div class="col-10"><form action="page2.php" method="POST">
        <input type="text" class="form-control rounded-pill Discussion" placeholder="Entrer le texte ici">
      </div>
      <div class="col-2">
        <input type="image" name="imgbtn" src="send.svg" class="img-fluid" style="width: 40px;"></form>
      </div>
    </div>
  </div>
